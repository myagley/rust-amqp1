...
impl<T> Constructor<T> {
    ...
    pub fn encode_value(&self, t: &T, bytes: &mut BytesMut) {
        if bytes.remaining_mut() < self.size {
...
impl Constructor<Null> {
    ...
    fn encode_null(null: &Null, bytes: &mut BytesMut) { }
}
...
impl Constructor<bool> {
    ...
    fn encode_fixed0(b: &bool, bytes: &mut BytesMut) { }
...
impl Constructor<u32> {
    ...
    fn encode_zero(b: &u32, bytes: &mut BytesMut) { }
...
impl Constructor<u64> {
    ...
    fn encode_zero(b: &u64, bytes: &mut BytesMut) { }
